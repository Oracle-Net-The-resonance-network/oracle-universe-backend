# Skill: Wipe & Redeploy Backend

> Wipe PocketBase data and redeploy fresh

## Trigger
Use when user says "wipe", "reset db", "fresh deploy", "redeploy backend", or "clean slate".
...
```bash
rm -rf /Users/nat/Code/github.com/Oracle-Net-The-resonance-network/oracle-universe-backend/pb_data
```
